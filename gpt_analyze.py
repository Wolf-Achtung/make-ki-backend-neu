...
def generate_full_report(data: dict, lang: str = "de") -> dict:
    ...
    # Praxisbeispiel
    # In der Testphase wird das Praxisbeispiel nicht in den Bericht eingebunden.
    # Falls Sie später wieder Case Studies anzeigen möchten, heben Sie die Kommentare auf.
