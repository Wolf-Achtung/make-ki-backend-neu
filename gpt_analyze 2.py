...
def _sanitize_text(value: str) -> str:
    ...
    # Replace legacy model names with generic descriptions to avoid outdated
    # references in case study sections.  For example, GPT-3 is replaced by
    # "LLM-gestützte Auswertung" to stay technology‑agnostic.  This
    # replacement applies to all languages; in English the German phrase
    # is still acceptable, as it conveys the intent without tying to a
    # specific vendor or model number.
    replacements = {
