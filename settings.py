...
# settings.py
# -*- coding: utf-8 -*-
"""Robuste Settings für das KI-Status-Report Backend (Pydantic v2).
- Akzeptiert `.env` (optional) und Environment-Variablen.
- Tolerantes Parsen von CORS-Origins (CSV, JSON-Array, einzelner Wert, '*').
- Enthält sinnvolle Defaults und Feature-Flags.
"""
