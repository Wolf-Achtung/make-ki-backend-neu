...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # ggf. auf deine Domain einschränken
...
def create_access_token(payload: Dict[str, Any], expires_seconds: int = 3600 * 12) -> str:
    """
    Erzeugt einen JWT-Token für das Frontend.
    Standardmäßig 12 Stunden Gültigkeit, damit längere Sessions nicht in 401 laufen.
    """
